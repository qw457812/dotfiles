...
const ALIASES: Record<string, ModelTarget> = {
  ...
  glmflash: { provider: "neuralwatt", id: "glm-5.3-flash" },
  ds: { provider: "commandcode", id: "deepseek/deepseek-v4-pro" },
  dsflash: { provider: "neuralwatt", id: "deepseek-v4-flash" },
  kimi: { provider: "commandcode", id: "moonshotai/Kimi-K3" },
  qwen: { provider: "commandcode", id: "Qwen/Qwen3.8-Max-0902" },
  qwenflash: { provider: "commandcode", id: "Qwen/Qwen3.8-Flash" },
