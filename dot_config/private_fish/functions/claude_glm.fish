...
function claude_glm --wraps=claude
    ...
    set -lx ANTHROPIC_DEFAULT_OPUS_MODEL glm-5.2
    set -lx ANTHROPIC_DEFAULT_SONNET_MODEL glm-5.2
    set -lx ANTHROPIC_DEFAULT_HAIKU_MODEL glm-4.7 # glm-4.5-air is not good enough
    set -lx ANTHROPIC_MODEL glm-5.2 # to disable 1M `context_window_size`
