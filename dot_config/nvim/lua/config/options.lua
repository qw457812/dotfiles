...
---@type "neo-tree.nvim"|"snacks.nvim"|"oil.nvim"|"mini.files"|"yazi.nvim"
...
-- https://github.com/yetone/avante.nvim/commit/f70c4b8
vim.g.root_spec = { { ".nvim.lua", ".lazy.lua" }, { ".git", ".svn" }, "lsp", { "lua" }, "cwd" }
...
vim.g.lazyvim_ts_lsp = not vim.g.user_is_termux and "tsc" or vim.g.lazyvim_ts_lsp
