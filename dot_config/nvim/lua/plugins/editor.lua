...
return {
...

  {
    ...
    keys = {
      ...
      { "<leader>rdx", function() return require("refactoring.debug").print_var({ output_location = "below" }) end, desc = "Debug Print Var Below", mode = { "n", "x" }, expr = true },
      { "<leader>rdX", function() return require("refactoring.debug").print_var({ output_location = "above" }) end, desc = "Debug Print Var Above", mode = { "n", "x" }, expr = true },
