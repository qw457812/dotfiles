...
return {
...

  {
    ...
    keys = {
      ...
      { "<leader>rI", function() return require("refactoring").inline_func() end, mode = { "n", "x" }, desc = "Inline Function", expr = true },
      { "<leader>rp", mode = { "n", "x" } },
      { "<leader>rP", false },
      { "<leader>rc", false },
      { "<leader>rd", "", desc = "+debug", mode = { "n", "x" } },
      { "<leader>rdx", function() return require("refactoring.debug").print_var({ output_location = "below" }) .. "iw" end, desc = "Debug Print Var Below", expr = true },
      { "<leader>rdx", function() return require("refactoring.debug").print_var({ output_location = "below" }) end, desc = "Debug Print Var Below", mode = "x", expr = true },
      { "<leader>rdX", function() return require("refactoring.debug").print_var({ output_location = "above" }) .. "iw" end, desc = "Debug Print Var Above", expr = true },
      { "<leader>rdX", function() return require("refactoring.debug").print_var({ output_location = "above" }) end, desc = "Debug Print Var Above", mode = "x", expr = true },
      { "<leader>rde", function() return require("refactoring.debug").print_exp({ output_location = "below" }) end, desc = "Debug Print Exp Below", mode = { "n", "x" }, expr = true },
      { "<leader>rdE", function() return require("refactoring.debug").print_exp({ output_location = "above" }) end, desc = "Debug Print Exp Above", mode = { "n", "x" }, expr = true },
      { "<leader>rdl", function() return require("refactoring.debug").print_loc({ output_location = "below" }) end, desc = "Debug Print Location Below", expr = true },
      { "<leader>rdL", function() return require("refactoring.debug").print_loc({ output_location = "above" }) end, desc = "Debug Print Location Above", expr = true },
      { "<leader>rdd", function() return require("refactoring.debug").cleanup({ restore_view = true }) end, desc = "Debug Cleanup", expr = true },
    },
  },
