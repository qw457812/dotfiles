  ...
  },
  {
    ...
    opts = function()
      ...
      vim.api.nvim_create_autocmd("BufRead", {
        ...
        pattern = {
          tmpdir .. (jit.os == "OSX" and "/" or "") .. "/fish.*/command-line.fish", -- https://github.com/fish-shell/fish-shell/blob/97ae05b69dbd01d3e5954dbd11a01dad6f5e0cdc/share/functions/edit_command_buffer.fish#L2-L4
