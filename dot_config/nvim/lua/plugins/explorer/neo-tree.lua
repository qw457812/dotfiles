...
return {
  ...
  -- https://github.com/rafi/vim-config/blob/master/lua/rafi/plugins/neo-tree.lua
  {
    ...
    opts = function(_, opts)
      ...
      -- related commits of neo-tree: since https://github.com/nvim-neo-tree/neo-tree.nvim/commit/7eadf08 and https://github.com/nvim-neo-tree/neo-tree.nvim/commit/46fa0c2
