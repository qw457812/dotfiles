...
| trackpad          | s/d + finger on trackpad     | copy word/selected                                                |                                                                            |          |                                            |
| trackpad          | f + finger on trackpad       | paste(hold f to overwrite)                                        |                                                                            |          |                                            |
| trackpad          | h/j/k/l + finger on trackpad | arrow keys(one finger), home/page_down/page_up/end(two fingers)   |                                                                            |          |                                            |
